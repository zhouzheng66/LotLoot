...
export class ContractData extends Singleton {
  ...
  private _componentContractIns: any = null;
  private _componentStoreContractIns: any = null;
  ...
  public get componentContract(): any {
    if (!this._componentContractIns) {
      this._componentContractIns = ContractComponent.create();
    }
    return this._componentContractIns;
  }
  ...
  public clearAllContracts() {
    ...
    this._componentContractIns = null;
    this._componentStoreContractIns = null;
  }
